		...
		<nav class="navbar-default navbar-static-side" role="navigation">
			<div class="sidebar-collapse">
				<ul class="nav metismenu" id="side-menu">
					...
					<li class="active"><a href="${home}user/pickuprequest"><i class="fa fa-edit fa-fw"></i> <span
					...
					<div class="col-sm-12">
						...
						<div class="wizard-container">
							<div class="card wizard-card" data-color="blue" id="wizard">
								<form action="${home}validate_xml" method="post"
												...
												<div class="col-sm-5">
													<div class="form-group">
														<button type="button" id="btn_search_docket"
															class="btn btn-info btn-wd" style="margin: 1px 1px;">
															Search
		                                         ...
		                                         <div class="row">
		                                             <div class="col-sm-6">
														...
														class="form-group label-floating is-empty">
		                                                     <label
															class="control-label">Length </label>
		                                                     <input
		                                             ...
		                                             <div class="col-sm-6">
														...
														class="form-group label-floating is-empty">
		                                                     <label
															class="control-label">Breadth </label>
		                                                     <input
															type="number" class="form-control pkg pkg-sv"
		                                     ...
		                                     <div class="col-sm-5">
		                                         <div class="row">
		                                             <div class="col-sm-6">
														...
														class="form-group label-floating is-empty">
		                                                     <label
															class="control-label">Height </label>
		                                                     <input
															type="number" class="form-control pkg pkg-sv"
